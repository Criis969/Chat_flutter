import 'dart:async';
import 'package:chat/widget/chatReceiver_widget.dart';
import 'package:chat/widget/chatSender_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.contact, style: TextStyle(color: Colors.white),),
      ),
      body: Container(
